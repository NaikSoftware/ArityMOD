...
public class GraphView extends View implements
    ...
    public String captureScreenshot() {
        ...
        drawGraph(canvas);
        return ua.naiksoftware.aritymod.core.util.Util.saveBitmap(bitmap, Grapher.SCREENSHOT_DIR, "calculator");
    }
